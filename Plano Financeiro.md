...
**Horizonte:** 24 meses
**Meta principal:** casamento abril/2028

| Renda mensal | Meta casamento | Prazo | Taxa de poupança |
|---|---|---|---|
| R$ 3.000 | R$ 25.000 | 24 meses | 50% |
...
**R$ 3.000 → Reserva de emergência**
CDB liquidez diária 100% CDI ou Tesouro Selic. Cobre ~10x gasto fixo. **Intocável.**

**R$ 2.800 → Primeiro aporte do casamento**
Tesouro Selic 2028. A partir do mês 1, soma R$ 1.000/mês.

## 4. Projeção do casamento (Tesouro Selic, ~0,75% a.m. líquido)

| Componente | Valor estimado |
|---|---|
| Aporte inicial (R$ 2.800) rendendo 24 meses | R$ 3.350 |
| Aportes mensais R$ 1.000 × 24 + juros | R$ 26.190 |
| **TOTAL em abril/2028** | **R$ 29.540** |
| Meta do casamento | R$ 25.000 |
| Folga (imprevistos / alianças / documentação) | ~R$ 4.500 |
...
**Inflação do setor de casamento** (buffet, fotógrafo, decoração) sobe ~6-8% a.a. R$ 25k hoje ≠ R$ 25k em 2028. Mirar **R$ 28-30k real**. O aporte de R$ 1.000/mês já cobre.

**Aluguel pós-casamento:** replanejar 12 meses antes. Saldo acumulado já permite calcular caução + móveis sem tocar na verba da festa.
